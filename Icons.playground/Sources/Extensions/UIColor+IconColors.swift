...
public extension UIColor {
    ...
    public static var iconOrangeColor: UIColor {
        return iconRedColor.colorWithHue(iconRedColor.hue + 0.1)
    }
    public static var iconLightGreenColor: UIColor {
        return iconRedColor.colorWithHue(iconRedColor.hue + 0.2)
    }
    public static var iconCyanColor: UIColor {
        return iconRedColor.colorWithHue(iconRedColor.hue + 0.4)
    }
