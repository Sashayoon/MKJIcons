...
public class FingerprintIcon: AnimatedIcon {
    ...
    override func draw(in context: CGContext, at time: CGFloat) {
        ...
        context.saveGState()
        context.setLineDash(phase: 0, lengths: [line9Dash, 300], count: 2)
        bezier3Path.stroke()
        ...
        context.saveGState()
        context.setLineDash(phase: 0, lengths: [line5Dash, 300], count: 2)
        bezier4Path.stroke()
        context.restoreGState()
        ...
        context.saveGState()
        context.setLineDash(phase: 0, lengths: [line4Dash, 300], count: 2)
        bezier5Path.stroke()
        context.restoreGState()
        ...
        context.saveGState()
        context.setLineDash(phase: 0, lengths: [line2Dash, 300], count: 2)
        bezier7Path.stroke()
        context.restoreGState()
        ...
        context.saveGState()
        context.setLineDash(phase: 0, lengths: [line6Dash, 300], count: 2)
        bezier8Path.stroke()
        context.restoreGState()
        ...
        context.saveGState()
        context.setLineDash(phase: 0, lengths: [line11Dash, 300], count: 2)
        bezier9Path.stroke()
        context.restoreGState()
        ...
        context.saveGState()
        context.setLineDash(phase: 0, lengths: [line7Dash, 300], count: 2)
        bezier10Path.stroke()
        context.restoreGState()
        ...
        context.saveGState()
        context.setLineDash(phase: 0, lengths: [line8Dash, 300], count: 2)
        bezier11Path.stroke()
        context.restoreGState()
        ...
        context.saveGState()
        context.setLineDash(phase: 0, lengths: [line10Dash, 300], count: 2)
        bezier12Path.stroke()
        context.restoreGState()
        ...
        context.saveGState()
        context.setLineDash(phase: 0, lengths: [line3Dash, 300], count: 2)
        bez1Path.stroke()
        context.restoreGState()
        ...
        context.saveGState()
        context.setLineDash(phase: 0, lengths: [line1Dash, 300], count: 2)
        bezier6Path.stroke()
        context.restoreGState()
